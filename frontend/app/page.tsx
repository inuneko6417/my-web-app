    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center">
      ...
      <main className="max-w-4xl px-4 text-center mt-16 md:mt-32">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          >
            今すぐレシピを抽出する
            <svg className="w-8 h-8 ml-3 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
            </svg>
          </Link>
          <p className="text-gray-400 text-sm font-medium">登録不要・今すぐ始められます</p>
        </div>
      ...
      <footer className="mt-auto py-10 w-full text-center border-t bg-white">
        <p className="text-gray-400 text-sm font-medium">© 2026 RecipeTube. </p>
      </footer>
    </div>
  );
}
